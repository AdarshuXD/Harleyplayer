...
TEMP_MONGODB = "mongodb+srv://aditya:aditya@cluster0.8iyye.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"


if config.MONGO_DB_URI is None:
    LOGGER(__name__).warning(
        "No MONGO DB URL found.. Your Bot will work on Aditya's Database"
    )
    temp_client = Client(
        "Aditya",
