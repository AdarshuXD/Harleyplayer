...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/adityabots/kaalmusicbot",
)
...
)  # Example:- https://t.me/adityaserver
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/adityadiscus
...
# 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 @𝐀𝐝𝐢𝐭𝐲𝐚𝐁𝐨𝐭𝐬 // @𝐀𝐝𝐢𝐭𝐲𝐚𝐇𝐚𝐥𝐝𝐞𝐫
...
PLAYLIST_IMG_URL = getenv(
    "PLAYLIST_IMG_URL",
    "resource/Playlist.jpeg",
)

GLOBAL_IMG_URL = getenv(
    "GLOBAL_IMG_URL",
    "resource/Global.jpeg",
)
...
STREAM_IMG_URL = getenv(
    "STREAM_IMG_URL",
    "resource/Stream.jpeg",
)

SOUNCLOUD_IMG_URL = getenv(
    "SOUNCLOUD_IMG_URL",
    "resource/Soundcloud.jpeg",
)

YOUTUBE_IMG_URL = getenv(
    "YOUTUBE_IMG_URL",
    "resource/Youtube.jpeg",
)

SPOTIFY_ARTIST_IMG_URL = getenv(
    "SPOTIFY_ARTIST_IMG_URL",
    "resource/SpotifyArtist.jpeg",
)

SPOTIFY_ALBUM_IMG_URL = getenv(
    "SPOTIFY_ALBUM_IMG_URL",
    "resource/SpotifyAlbum.jpeg",
)

SPOTIFY_PLAYLIST_IMG_URL = getenv(
    "SPOTIFY_PLAYLIST_IMG_URL",
    "resource/SpotifyPlaylist.jpeg",
)
